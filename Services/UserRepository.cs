...
namespace StendenCafe.Services
{
    ...
    public class UserRepository : BaseRepository
    {
        ...
        public async Task<CafeUser> Add(CafeUser cafeUser)
        {
            ...
            return await connection.QuerySingleAsync<CafeUser>(@"INSERT INTO Cafeuser (Id, Username, Password, Location)
																VALUES (@Id, @Username, @Password, Location);
																SELECT * FROM Cafeuser
																WHERE Id = @Id",
                                                                new { cafeUser.Id, cafeUser.Username, cafeUser.Password, cafeUser.Location });
        }
